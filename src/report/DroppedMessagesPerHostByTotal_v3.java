 ...
 */
public class DroppedMessagesPerHostByTotal_v3 extends Report implements MessageListener {
     ...
     */
    public DroppedMessagesPerHostByTotal_v3() {
        init();
    ...
    public void done() {
        ...
        TreeMap<DTNHost, Integer> sortedDropped = new TreeMap<>((a, b) ->  Integer.compare(droppedPerNode.get(b), droppedPerNode.get(a)));
