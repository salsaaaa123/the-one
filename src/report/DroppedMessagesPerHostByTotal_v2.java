 ...
 */
public class DroppedMessagesPerHostByTotal_v2 extends Report implements MessageListener {
     ...
     */
    public DroppedMessagesPerHostByTotal_v2() {
    ...
    public void done() {
        ...
        TreeMap<DTNHost, Integer> sortedDropped = new TreeMap<>((a, b) ->  Integer.compare(droppedPerNode.get(a), droppedPerNode.get(b)));
