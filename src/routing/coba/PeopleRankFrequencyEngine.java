...
//import java.util.*;
//
//public class PeopleRankFrequencyEngine implements RoutingDecisionEngine, NodeRanking {
//
...
//
//    public PeopleRankFrequencyEngine(Settings s) {
...
//    }
//
//    public PeopleRankFrequencyEngine(PeopleRankFrequencyEngine proto) {
...
//        PeopleRankFrequencyEngine prde = getDecisionRouterFrom(peer);
...
//        }
//
//        PeopleRankFrequencyEngine prde = getDecisionRouterFrom(otherHost);
//        double otherHostRank = prde.getPeopleRank();
//
//        return otherHostRank >= peopleRank;
//    }
//
//    public PeopleRankFrequencyEngine getDecisionRouterFrom(DTNHost h) {
...
//            if (engine instanceof PeopleRankFrequencyEngine) {
//                return (PeopleRankFrequencyEngine) engine;
//            } else {
...
//        return new PeopleRankFrequencyEngine(this);
//    }
//
//    @Override
...
////
////    protected Map<DTNHost, Double> startTime;
////    protected Map<DTNHost, Integer> connectionHistoryFrequency; // Menyimpan frekuensi pertemuan
////    protected Map<DTNHost, PeopleRankInfo> peerInfo;
////    protected List<Message> messageBuffer;
////    protected Set<DTNHost> socialGraph;
////
...
////        connectionHistoryFrequency = new HashMap<>();
...
////        startTime = new HashMap<>();
////        connectionHistoryFrequency = new HashMap<>(proto.connectionHistoryFrequency);
...
////        connectionHistoryFrequency.put(peer, connectionHistoryFrequency.getOrDefault(peer, 0) + 1); // Tingkatkan frekuensi
////    }
////
////    @Override
////    public void connectionDown(DTNHost thisHost, DTNHost peer) {
...
////    }
////    private void updateSocialGraph(DTNHost thisHost, DTNHost peer) {
////        // Periksa frekuensi pertemuan untuk menentukan ketetanggaan
////        int frequency = connectionHistoryFrequency.containsKey(peer) ? connectionHistoryFrequency.get(peer) : 0;
////        if (frequency >= frequencyThreshold) {
////            socialGraph.add(peer);
////            socialGraph.add(thisHost);
////        } else {
...
////        double otherHostRank = prde.getPeopleRank();
////
////        return otherHostRank >= this.peopleRank;
////    }
////
////
////    public PeopleRankFrequencyEngine getDecisionRouterFrom(DTNHost h) {
