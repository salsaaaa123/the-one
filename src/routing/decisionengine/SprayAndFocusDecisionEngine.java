...
public class SprayAndFocusDecisionEngine implements RoutingDecisionEngine
{
    ...
    public SprayAndFocusDecisionEngine(SprayAndFocusDecisionEngine snf)
    {
    ...
    {
        SprayAndFocusDecisionEngine de = this.getOtherSprayAndFocusDecisionEngine(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost)
    {
        ...
        SprayAndFocusDecisionEngine de = this.getOtherSprayAndFocusDecisionEngine(otherHost);
    ...
    private SprayAndFocusDecisionEngine getOtherSprayAndFocusDecisionEngine(DTNHost h)
    {
