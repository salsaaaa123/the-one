 ...
 * 
 * <p>
 * By: Falaki, Hossein and Mahajan, Ratul and Kandula, Srikanth and
 ...
 * 
 * <p>
 * The work presents an activeness model where the duration of active
 ...
 * 
 * <p>
 * By default this class will select these parameters from their acceptable
 ...
 * 
 * <p>
 * A main method is included within this class that can be used to test a
 * set of parameters.
 * </p>
 * 
...
public class SmartphoneActiveness implements Activeness {
	...
	protected double nextDuration() {
		...
		if (pickDist < r)
			return erng.nextValue();
		else
			return prng.getDouble();
	}
	...
	public static void main(String[] args) {
		...
		if (args.length > 0) {
			...
			for (int i = 0; i < trials; i++) {
				...
				if (lengthFreq.containsKey(index))
					value = lengthFreq.get(index);
